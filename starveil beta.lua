...
lua.pui.ui = {} do
    ...
    lua.pui.ui.selectab = {
        maing = lua.pui.ui.group.main:label('  Ⳋ┃Ⳓ   ' .._nam .. '   Ⳋ┃Ⳓ                    ', {230, 230, 230, 230}),
        group = lua.pui.ui.group.main:combobox('\n  Selection', {'  home', '  Builder', '  Antiaim', '  Visuals', '  Other'})
    }

    lua.pui.ui.lerping = lua.pui.ui.group.main:label('‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾')
    lua.pui.ui.lerping3 = lua.pui.ui.group.main:label('Author • ayatohvh')
    lua.pui.ui.lerping3 = lua.pui.ui.group.main:label('Last Update • 20.09.2025')
    ...
    lua.pui.ticks = -1
    lua.pui.state = 'Global'
    lua.pui.Condition_names = {'Global', 'Standing', 'Moving', 'Walking', 'Creeping', 'Crawling', 'Air', 'Air+', 'Using'}
    lua.pui.ui.Conditions = {}
    lua.pui.ui.state = lua.pui.ui.group.main:combobox('  Condition', lua.pui.Condition_names):depend( {lua.pui.ui.selectab.group, lua.pui.ui.builder_way} )
    ...
    for i, name in pairs(lua.pui.Condition_names) do
        lua.pui.ui.Conditions[name] = {
            ...
            randomize = lua.pui.ui.group.main:slider('Randomize\n'..name, 0, 100, 0, true, '%'),
            dstart = lua.pui.ui.group.main:slider('Defensive start\n'..name, 0, 10, 1, true, 't'),
            spray = lua.pui.ui.group.main:slider('Spray speed\n'..name, 1, 5, 3, true, 't'),
            delay = lua.pui.ui.group.main:slider('Delay tick\n'..name, 1, 10, 1, true, 't')
        }
    end
...
lua.antiaim = {} do
    ...
    lua.antiaim.state = function ()
        ...
        if not lua.antiaim.onground then
            if entity.get_prop(me, 'm_flDuckAmount') == 1 and lua.pui.ui.Conditions['Air+'].override:get() then
                return 'Air+'
            end
